...
import OptionAddDialog from '../components/OptionAddDialog.vue'
...
// 新增提交
const handleAddSubmit = (payload: { name: string; options: Array<{ text: string; score: number }>; status: string }) => {
  ...
  tableData.value.unshift(newOption)
  ElMessage.success('新增成功')
}

// 查看
const handleView = (row: Option) => {
  console.log('查看', row)
  ElMessage.info(`查看选项: ${row.name}`)
}

// 启用/禁用
const handleToggleStatus = (row: Option) => {
  ...
  <div class="option-management">
    <div class="content-card">
      ...
      <div class="table-section">
        ...
        >
          <el-table-column prop="name" label="选项名称" min-width="590" />
