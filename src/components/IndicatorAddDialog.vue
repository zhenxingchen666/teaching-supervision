...
<template>
  <Teleport to=".design-canvas" defer>
    <div v-if="visible" class="indicator-mask" @click.self="close">
      <div class="indicator-dialog">
        <!-- banner -->
        <div class="dialog-banner">
          <h3 class="dialog-title">新增指标</h3>
...
<style>
.indicator-select-popper .el-select-dropdown__item {
  font-size: 13px;
  padding: 0 12px;
  height: 34px;
  line-height: 34px;
...
.indicator-select-popper .el-select-dropdown__item.is-selected {
  color: #1947ff;
  font-weight: 500;
}

.indicator-select-popper .el-select-dropdown__item:hover {
